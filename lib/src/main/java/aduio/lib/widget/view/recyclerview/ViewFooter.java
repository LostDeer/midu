...
/**
 */
public class ViewFooter extends BaseFooter {
...
//    private RotateAnimation mRotateDownAnim;
    ...
    public ViewFooter(Context context, boolean isShowText){
        this(context, 0,R.drawable.loding,0,isShowText);
    }

    public ViewFooter(Context context, int logoSrc){
        this(context, 0,R.drawable.loding,logoSrc,false);
    }

    public ViewFooter(Context context, int logoSrc, boolean isShowText){
        this(context, 0,R.drawable.loding,logoSrc,isShowText);
    }

    public ViewFooter(Context context, int rotationSrc, int arrowSrc, int logoSrc, boolean isShowText){
...
//        mRotateDownAnim.setFillAfter(true);
    ...
    public View getView(LayoutInflater inflater, ViewGroup viewGroup) {
        View view = inflater.inflate(R.layout.view_footer, viewGroup, true);
...
//                footerArrow.startAnimation(mRotateDownAnim);
    ...
    public void onStartAnim() {
        ...
        footerProgressbar.startAnimation(AnimationUtils.loadAnimation(context,
